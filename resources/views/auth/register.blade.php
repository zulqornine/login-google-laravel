            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-register-image">
                        <img src="{{ asset("sb/img/pp2.jpg") }}" alt="" class="img-fluid h-100 w-100">
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form method="POST" action="{{ route('register.post') }}" class="user">
                                ...
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control form-control-user" id="exampleName" placeholder="Full Name" value="{{ old('name') }}">
                                    @error('name')
